...
# ==========================================================
# Latihan 3 Membuat Tranversal Preorder 
# ==========================================================
...
'''
Pembahasan: 
Setelah saya pahami dari kode diatas kode tersebut membuat struktur binary tree dan melakukan traversal preorder (Root → Left → Right) menggunakan fungsi rekursif. Program membangun tree dengan root "A", lalu menampilkan urutan node sesuai metode preorder saat fungsi preorder(root) dijalankan.
'''