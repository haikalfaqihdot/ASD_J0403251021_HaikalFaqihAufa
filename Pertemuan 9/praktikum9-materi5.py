...
# ==========================================================
# Latihan 5 Membuat Tranversal Postorder 
# ==========================================================
...
# Menjalankan tranversal postorder
...
'''
Pembahasan: 
Setelah saya pahami dari kode diatas kode tersebut membuat struktur binary tree dan melakukan traversal postorder (Left → Right → Root) menggunakan fungsi rekursif. Program membuat tree dengan root "A", lalu menampilkan urutan node sesuai metode postorder saat fungsi postorder(root) dijalankan.
'''